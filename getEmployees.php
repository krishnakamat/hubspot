...
<?php
$activeEmpNum = "select * from webadmin where (userRole = 1 or userRole = 2 or userRole = 3) and status = '$status' and adminID NOT IN(18,19) and empID!=0 and employeeType = 1";
...
<?php
			...
			$allUsers="select * from webadmin where (userRole = 1 or userRole = 2 or userRole = 3)and adminID NOT IN(18,19) and empID!=0 and status = '$status' and employeeType = 1 order by name";
