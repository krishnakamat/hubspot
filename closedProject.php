...
$allSsb="select *,sum(hours2) as hours,max(closedID) as maxID,count(closedID) as totaloccurence from closedssb where status ='Closed' and closedOn='$today' and isManual !='1' group by ssbID ";
...
<table class="sortable" border="2" ><thead><tr style="background:#ccc;"><th>Sr. No.</th><th >SSB-ID</th><th>Customer Subscription Name</th><th>Queue</th><th>Start Date</th><th>Due Date</th><th>Service</th><th>URL To Migrate</th><th>Pages</th><!--<th>Owner</th>--><th>Hours 2</th><th>Action</th></tr></thead>
<?php
$x=0;
